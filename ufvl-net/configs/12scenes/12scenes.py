...
dataset_type = 'ufvl_net.TWESCENES'
# root='/home/dk/SCORE_Methods/EAAINet/data/'
root='/home/dk/SCORE_Methods/EAAINet/data/'
scene='office1/lounge'
all_scene = ['apt1kitchen','apt1living','apt2bed','apt2kitchen',
            'apt2living','apt2luke','office1gates362',
            'office1gates381','office1lounge','office1manolis',
            'office25a','office25b']
share_type = "kernel"          # channel or kernel
